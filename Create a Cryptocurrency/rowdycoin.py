...
# Part 2:  Minging our Blockchain

# Creating web APP
app = Flask(__name__)

# Creatung an address for the node on port 5000
...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver="Rowdy", amount=1)
...
def connect_node():
    ...
    response = {
        "message": f"All the nodes are now connected. The Rowdy Blockchain now contains following nodes:",
